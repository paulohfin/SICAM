...
<html lang="pt-br">
	...
	<body>	
		...
		<header>
			<h3>Previsões de férias para os estagiários: </h3>
		...
		<form method='POST'>
					...
					if ($estagiarios){
						foreach ($estagiarios as $estagiario){
							...
							echo '<tr>
								...
								<td>' . date("d/m/Y", strtotime($estagiario['inicio_ferias'])) . '</td>
						...
						echo '<tr>
								<td><i data-toggle="tooltip" data-placement="left" title="Estagiário notificado" class="material-icons icons-designe" style="color: green">done</i></td>
							</tr>'; 
				?>
			...
			<div class="col col-md-12 col-lg-12 botao">            
				...
				<a href="#" style="text-decoration: none; padding-left: 10px">  
					<button type="submit" class="btn btn-primary" name='atualizar_ferias'>Atualizar</button>
				</a>
			</div>
		</form>
